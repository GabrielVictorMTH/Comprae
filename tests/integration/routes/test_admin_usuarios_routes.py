...
class TestListarUsuarios:
    ...
    def test_listar_usuarios_requer_admin(self, comprador_autenticado):
        """Comprador não deve acessar listagem de usuários"""
...
class TestCadastrarUsuario:
    ...
    def test_get_cadastrar_requer_admin(self, comprador_autenticado):
        """Comprador não deve acessar formulário de cadastro"""
        response = comprador_autenticado.get(
...
class TestEditarUsuario:
    ...
    def test_get_editar_requer_admin(self, comprador_autenticado, criar_usuario):
        """Comprador não deve acessar formulário de edição"""
        ...
        # Comprador pode receber 200 mas sem permissão, ou redirect/403
...
class TestExcluirUsuario:
    ...
    def test_comprador_nao_pode_excluir_usuario(
        self, comprador_autenticado, criar_usuario
    ):
        """Comprador não deve poder excluir usuários"""
        criar_usuario("Outro Usuario", "outro@example.com", "Senha@123")
