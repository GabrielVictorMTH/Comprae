...
class TestCriarChamado:
    ...
    def test_get_formulario_cadastro(self, comprador_autenticado):
        """Usuário autenticado deve acessar formulário de cadastro"""
        response = comprador_autenticado.get("/chamados/cadastrar")
        assert response.status_code == status.HTTP_200_OK
        assert "chamado" in response.text.lower()

    def test_criar_chamado_com_dados_validos(self, comprador_autenticado):
    ...
    def test_criar_chamado_titulo_curto(self, comprador_autenticado):
    ...
    def test_criar_chamado_titulo_longo(self, comprador_autenticado):
    ...
    def test_criar_chamado_descricao_curta(self, comprador_autenticado):
    ...
    def test_criar_chamado_sem_prioridade(self, comprador_autenticado):
    ...
    def test_criar_chamado_prioridade_invalida(self, comprador_autenticado):
    ...
    def test_chamado_criado_com_status_aberto(self, comprador_autenticado):
        ...
        response = comprador_autenticado.get("/chamados/listar")
        assert response.status_code == status.HTTP_200_OK
...
class TestListarChamados:
    ...
    def test_listar_chamados_usuario(self, comprador_autenticado):
        """Usuário deve conseguir listar seus chamados"""
        response = comprador_autenticado.get("/chamados/listar")
        assert response.status_code == status.HTTP_200_OK
        assert "chamado" in response.text.lower()

    def test_usuario_ve_apenas_proprios_chamados(self, client, comprador_autenticado):
        """Usuário deve ver apenas seus próprios chamados"""
        # Este comprador já está autenticado como um usuário comum
...
class TestVisualizarChamado:
    ...
    def test_visualizar_proprio_chamado(self, comprador_autenticado):
        """Usuário deve visualizar detalhes do próprio chamado"""
        # Criar chamado
        comprador_autenticado.post(
            "/chamados/cadastrar",
            data={
        ...
        response = comprador_autenticado.get("/chamados/1/visualizar")
        assert response.status_code == status.HTTP_200_OK
        assert "Problema urgente" in response.text

    def test_visualizar_chamado_inexistente(self, comprador_autenticado):
        """Deve retornar erro ao visualizar chamado inexistente"""
        response = comprador_autenticado.get(
...
class TestExcluirChamado:
    ...
    def test_excluir_proprio_chamado(self, comprador_autenticado):
    ...
    def test_excluir_chamado_inexistente(self, comprador_autenticado):
...
class TestAdminListarChamados:
    ...
    def test_usuario_comum_nao_acessa_admin_listagem(self, comprador_autenticado):
...
class TestAdminResponderChamado:
    ...
    def test_admin_acessa_formulario_responder(
        self, comprador_autenticado, admin_autenticado
    ):
        ...
        assert (
            "resposta" in response.text.lower()
            or "responder" in response.text.lower()
            or "mensagem" in response.text.lower()
        )
    ...
    def test_usuario_comum_nao_pode_responder(self, comprador_autenticado):
...
class TestHistoricoInteracoes:
    ...
    def test_usuario_pode_responder_proprio_chamado(self, comprador_autenticado):
...
class TestReabrirChamado:
    ...
    def test_reabrir_chamado_nao_fechado(
        self, comprador_autenticado, admin_autenticado
    ):
...
class TestErrosAdminChamados:
    ...
    def test_erro_ao_salvar_resposta(self, comprador_autenticado, admin_autenticado):
    ...
    def test_erro_ao_fechar_chamado(self, comprador_autenticado, admin_autenticado):
    ...
    def test_erro_ao_reabrir_chamado(self, comprador_autenticado, admin_autenticado):
...
class TestRateLimitChamados:
    ...
    def test_rate_limit_criar_chamado(self, comprador_autenticado):
    ...
    def test_rate_limit_responder_chamado(self, comprador_autenticado):
...
class TestExclusaoChamado:
    ...
    def test_excluir_chamado_nao_aberto(self, comprador_autenticado, admin_autenticado):
...
class TestValidacaoResposta:
    ...
    def test_resposta_invalida_validation_error(self, comprador_autenticado):
    ...
    def test_responder_chamado_inexistente(self, comprador_autenticado):
