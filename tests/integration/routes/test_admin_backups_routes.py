...
class TestListarBackups:
    ...
    def test_listar_backups_requer_admin(self, comprador_autenticado):
        """Comprador não deve acessar listagem de backups"""
...
class TestCriarBackup:
    ...
    def test_comprador_nao_pode_criar_backup(self, comprador_autenticado):
        """Comprador não deve poder criar backup"""
...
class TestRestaurarBackup:
    ...
    def test_comprador_nao_pode_restaurar_backup(
        self, comprador_autenticado, criar_backup
    ):
        """Comprador não deve poder restaurar backup"""
        criar_backup()
        from util import backup_util
...
class TestExcluirBackup:
    ...
    def test_comprador_nao_pode_excluir_backup(
        self, comprador_autenticado, criar_backup
    ):
        """Comprador não deve poder excluir backup"""
        criar_backup()
        from util import backup_util
...
class TestDownloadBackup:
    ...
    def test_comprador_nao_pode_baixar_backup(
        self, comprador_autenticado, criar_backup
    ):
        """Comprador não deve poder baixar backup"""
        criar_backup()
        from util import backup_util
