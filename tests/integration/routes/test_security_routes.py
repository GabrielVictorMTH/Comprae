...
class TestEscalacaoPrivilegios:
    ...
    def test_comprador_nao_pode_acessar_admin_usuarios(self, comprador_autenticado):
        """Comprador não deve acessar painel de administração de usuários"""
    ...
    def test_comprador_nao_pode_criar_usuario_como_admin(self, comprador_autenticado):
        """Comprador não deve poder acessar endpoint de criação de usuário admin"""
    ...
    def test_vendedor_nao_pode_criar_backup(self, vendedor_autenticado):
        ...
        response = vendedor_autenticado.post(
